...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.87-kirby-problem-4.87-42178f4a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.87"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.87-kirby-problem-4.87-42178f4a-v1",
      "problem_contract_sha256": "ec921ed2bc2776fd90356f293d2282ae1d74337a5731d4018f227a6b355fa6b1",
      "problem_id": "problem:um-kp-4.87-kirby-problem-4.87-42178f4a",
      "route_id": "route:um-kp-4.87-kirby-problem-4.87-42178f4a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.87-kirby-problem-4.87-42178f4a-source-fidelity-01",
      "graph_id": "graph:um-kp-4.87-kirby-problem-4.87-42178f4a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.87-kirby-problem-4.87-42178f4a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.87-kirby-problem-4.87-42178f4a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there an exotic action of $\\mathbb{Z}/n$ on $S^{4}$ with 0-dimensional fixed point set? 1-dimensional? 2-dimensional?"
          },
          "statement_sha256": "344bea69bc50d16579c4bec86106d209f3fccfa8f1e819f222a09fc7eb74491d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.87-kirby-problem-4.87-42178f4a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.87-kirby-problem-4.87-42178f4a-root",
      "route_id": "route:um-kp-4.87-kirby-problem-4.87-42178f4a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.87-0e8c31fe0583",
        "url": "https://www.unsolvedmath.com/problems/KP-4.87"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
